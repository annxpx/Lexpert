  ...
  types: [
    {
      ...
      categories: [
        ...
        {
          id: 2,
          value: "Contrato por Tiempo Limitado",
          clauses: {
            mandatory: [
        ...
        {
          id: 3,
          value: "Contrato por Obra o Servicio Determinado",
          clauses: {
            mandatory: [
    ...
    {
      id: 2,
      value: "Contratos de Arrendamiento",
      categories: [
        {
          id: 1,
        ...
        {
          id: 2,
          value: "Arrendamiento de Bienes Muebles",
          clauses: {
            mandatory: [
